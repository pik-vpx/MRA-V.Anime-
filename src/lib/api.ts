...
// import { findAnimeFromGoogle } from './gemini'; // Gemini AI disabled
 ...
 * Search chain: AnisongDB → AnimeThemes
 */
export async function findAnimeForTrack(
  ...
  // Direct Google AI path disabled – Gemini AI is not used in the current flow.
  // if (source === 'google') {
  ...
  // ── Stage 3: Google Gemini AI Fallback (disabled) ──
  // Gemini AI fallback has been disabled as it is not functional.
